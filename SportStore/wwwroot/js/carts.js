...
$(function () {
    ...
    $allCheckbox.click(function () {
        ...
        if (id< 0) {
            if (t.is(':checked')) {
                //t.next('label').addClass('mark');
            } else {
                //t.next('label').removeClass('mark')
            }
        }
        else {
            var selected;
    ...
    $all_sum.keyup(function () {
        var $this = $(this);
        var newCount = $this.val().replace(/\D|^0/g, '');
        var id = $this.prop('id');
        $.ajax({
