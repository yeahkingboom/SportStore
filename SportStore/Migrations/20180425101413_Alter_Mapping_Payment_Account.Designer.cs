...
namespace SportStore.Migrations
{
    ...
    [Migration("20180425101413_Alter_Mapping_Payment_Account")]
    partial class Alter_Mapping_Payment_Account
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportStore.Models.Apply", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SportStore.Models.MallInfo", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SportStore.Models.Payment", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SportStore.Models.Reply", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SportStore.Models.Apply", b =>
                {
                    b.HasOne("SportStore.Models.Account", "Account")
                        .WithOne("Apply")
                        .HasForeignKey("SportStore.Models.Apply", "AccountID")
            ...
            modelBuilder.Entity("SportStore.Models.Order", b =>
                {
                    ...
                    b.HasOne("SportStore.Models.Payment", "PayMent")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("SportStore.Models.Reply", b =>
                {
                    ...
                    b.HasOne("SportStore.Models.Comment", "Comment")
                        .WithMany("Replies")
